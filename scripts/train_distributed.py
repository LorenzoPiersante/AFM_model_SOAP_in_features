...
from models import AttentionEncoderUNet, GNN_env, GridGraphImgNet, GridMultiAtomLoss
import SOAP_utils as Sutil

hdf5_path = './graph_dataset.hdf5'                       # Path to HDF5 database where data is read from
model_dir = './model_random_order_distr_modified'        # Directory where all model files are saved
epochs = 50                                              # Number of epochs to train
batch_size = 340                                         # Number of samples per batch
...
num_workers = 6                                          # Number of parallel workers for each GPU
